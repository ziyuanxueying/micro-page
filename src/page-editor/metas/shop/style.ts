import { flexc, textSingle, textTwice, colors, textGray9 } from '@global'
const shopItem1 = css([flexc, { width: '50%' }])
...
const shopItem2 = css([flexc, { width: '33%' }])
...
const shopItem3 = css([flexc, { width: '35%' }])
