      ...
      for (
        var r = function (r, n) {
          ...
          t = function (r) {
            ...
            return (
              (t && r[6] >= 4 * n && r[0] >= n ? 1 : 0) + (t && r[0] >= 4 * n && r[6] >= n ? 1 : 0)
            )
          },
          o = 0,
          f = e * e,
        ...
        for (
          ...
          var C = a[u][p]
          C && i++,
            p && u && C == a[u][p - 1] && C == a[u - 1][p] && C == a[u - 1][p - 1] && (o += 3)
        }
    ...
    O = function () {
      ...
      for (
        var t = (function () {
            ...
            if (n > 1)
              for (
                var t = 2 + ((n / 7) | 0), o = 32 == n ? 26 : 2 * v((e - 13) / (2 * t - 2));
                t--;
              )
                r[t] = t * o + 6
            return r
    ...
    for (L(g.msg || '', m[g.ecl] || m.M, 0 == g.ecb ? 0 : 1, g.mtx), v = e + 2 * c, i = e; i--; )
      for (u = 0, f = e; f--; )
        a[i][f] &&
          (A
            ? (u++,
              a[i][f - 1] || ((l += 'M' + f + ',' + i + 'h' + u + 'v1h-' + u + 'v-1z'), (u = 0)))
            : (l += 'M' + f + ',' + i + 'h1v1h-1v-1z'))
    return (
      (o = t('svg', {
